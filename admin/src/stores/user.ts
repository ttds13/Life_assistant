...
export const useUserStore = defineStore("user", () => {
  ...
  async function login(loginRequest: LoginRequest): Promise<void> {
    ...
    AuthStorage.setTokens(accessToken, refreshToken || accessToken, rememberMe.value);
  }
  ...
  async function doRefreshToken(): Promise<void> {
    ...
    AuthStorage.setTokens(accessToken, newRefreshToken || accessToken, AuthStorage.getRememberMe());
  }
