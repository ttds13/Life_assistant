...
export const ADMIN_PERMISSION = {
  ...
  STAFF_NOTIFICATION_VIEW: 'staff:notification:view',
  STAFF_NOTIFICATION_RESEND: 'staff:notification:resend',
  STAFF_PROFILE_CHANGE_VIEW: 'staff:profile-change:view',
  STAFF_PROFILE_CHANGE_REVIEW: 'staff:profile-change:review',
  ...
  MARKETING_USER_COUPON_LIST: 'marketing:user-coupon:list',
  MARKETING_COUPON_GRANT: 'marketing:coupon:grant',
...
const OPERATOR_PERMISSIONS = [
  ...
  ADMIN_PERMISSION.STAFF_NOTIFICATION_VIEW,
  ...
  ADMIN_PERMISSION.MEMBER_CARD_CREATE,
  ADMIN_PERMISSION.MEMBER_CARD_UPDATE,
